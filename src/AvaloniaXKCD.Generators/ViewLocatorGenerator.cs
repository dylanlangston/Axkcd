...
namespace AvaloniaXKCD.Generators
{
    ...
    public class ViewLocatorGenerator : IIncrementalGenerator
    {
        ...
        private static void GenerateSource(SourceProductionContext spc, ImmutableArray<DiscoveredType?> types, ImmutableArray<TargetClassInfo?> targets)
        {
            ...
            if (targets.Length > 1)
            {
                Report(spc, "XKC001", "Multiple ViewLocator classes",
            ...
            var viewsByBaseName = validTypes
                ...
                .ToDictionary(
                    t => t!.ClassName.Substring(0, t.ClassName.Length - "View".Length),
                    t => t!.FullTypeName
                );
            ...
            {
                var viewModelBaseName = viewModel!.ClassName.Substring(0, viewModel.ClassName.Length - "ViewModel".Length);
                ...
                else
                {
                    ...
                    Report(spc, "XKC101", "Orphaned ViewModel",
            ...
            if (template.HasErrors)
            {
                ...
                Report(spc, "XKC103", "Scriban template parsing error", $"The Scriban template has errors:\n{errors}", DiagnosticSeverity.Error);
                return;
            }
        ...
        private static string GetEmbeddedResource(string resourceName)
        {
            ...
            using var stream = assembly.GetManifestResourceStream(fullName)
                ?? throw new FileNotFoundException($"Embedded resource '{fullName}' not found. Available: {string.Join(", ", assembly.GetManifestResourceNames())}");
