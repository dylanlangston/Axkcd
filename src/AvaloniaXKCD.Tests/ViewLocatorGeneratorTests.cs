...
public class ViewLocatorGeneratorTests
{
                ...
                _.GeneratedTrees.ShouldSatisfyAllConditions([
                    ...
                    trees =>
                        trees
                            ...
                            .GetText()
                            .ToString()
                            .ShouldContain("{ typeof(TestNamespace.MainViewModel), typeof(TestNamespace.MainView) }"),
                ])
            );
    }
                    ...
                    trees =>
                        trees
                            ...
                            .ShouldSatisfyAllConditions([
                                text =>
                                    text.ShouldContain(
                                        "{ typeof(Test.ViewModels.HomeViewModel), typeof(Test.Views.HomeView) }"
                                    ),
                                text =>
                                    text.ShouldContain(
                                        "{ typeof(Test.ViewModels.SettingsViewModel), typeof(Test.Views.SettingsView) }"
                                    ),
                            ]),
                ])
            );
    ...
    {
        var sourceFile =
            $"{nameof(ViewLocatorGeneratorTests)}.{nameof(IgnoresOrphanedViewModelAndReportsDiagnostic)}.cs";
        return Verify<ViewLocatorGenerator>(sourceFile)
            .Assert<GeneratorDriverRunResult>(
                    ...
                    trees =>
                        trees
                            ...
                            .ShouldSatisfyAllConditions([
                                ...
                                text =>
                                    text.ShouldContain(
                                        "{ typeof(TestNamespace.LoginViewModel), typeof(TestNamespace.LoginView) }"
                                    ),
                            ]),
                ])
            );
                    ...
                    trees =>
                        trees
                            ...
                            .ShouldSatisfyAllConditions([
                                ...
                                text =>
                                    text.ShouldContain(
                                        "{ typeof(TestNamespace.ProfileViewModel), typeof(TestNamespace.ProfileView) }"
                                    ),
                            ]),
                ])
            );
    ...
    {
        var sourceFile =
            $"{nameof(ViewLocatorGeneratorTests)}.{nameof(IgnoresAbstractClassesAndPairsConcreteImplementations)}.cs";
        return Verify<ViewLocatorGenerator>(sourceFile)
            .Assert<GeneratorDriverRunResult>(_ =>
                _.GeneratedTrees.ShouldSatisfyAllConditions([
                    trees => trees.Length.ShouldBe(2),
                    trees =>
                        trees
                            ...
                            .ShouldSatisfyAllConditions([
                                ...
                                text =>
                                    text.ShouldContain(
                                        "{ typeof(TestNamespace.DetailsViewModel), typeof(TestNamespace.DetailsView) }"
                                    ),
                            ]),
                ])
            );
    ...
    public Task GeneratesNoViewLocatorWhenAttributeMissing()
    {
        ...
        return Verify<ViewLocatorGenerator>(sourceFile)
            .Assert<GeneratorDriverRunResult>(
                ...
                _ =>
                _.GeneratedTrees.ShouldHaveSingleItem().GetText().ToString().ShouldContain("ViewLocatorAttribute")
            );
    }
    ...
    {
        var sourceFile =
            $"{nameof(ViewLocatorGeneratorTests)}.{nameof(DetectsMultipleViewLocatorAttributesAndReportsError)}.cs";
        return Verify<ViewLocatorGenerator>(sourceFile)
            .Assert<GeneratorDriverRunResult>(_ =>
                _.Diagnostics.ShouldSatisfyAllConditions([
