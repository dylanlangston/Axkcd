...
public interface ILogger : IExport
{
    ...
    void Log(LogLevel level, string message, [System.Runtime.CompilerServices.CallerFilePath] string? file = null);
    public void Log(
        LogLevel level,
        Exception err,
...
public abstract class BaseLogger : ILogger
{
    ...
    public bool ShouldLogInformation
    {
        get => ShouldLog(LogLevel.Information);
    }
    public bool ShouldLogWarning
    {
        get => ShouldLog(LogLevel.Warning);
    }
    public bool ShouldLogError
    {
        get => ShouldLog(LogLevel.Error);
    }
    public bool ShouldLogCritical
    {
        get => ShouldLog(LogLevel.Critical);
    }
...
public static class LoggerExtensions
{
    ...
    public static bool IfShouldLogCritical(
        this ILogger logger,
        Func<string> message,
        [System.Runtime.CompilerServices.CallerFilePath] string? file = null
