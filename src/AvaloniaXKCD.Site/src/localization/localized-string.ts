...
class LocalizedString extends LitElement {
  ...
  private static strings: Record<string, () => string> = {
    ...
    'Page_Subtitle': () => msg('Because laughing in C# is still (technically) laughing.', { id: 'Page_Subtitle' }),
    'DevBanner_Text': () => msg('In Development', { id: 'DevBanner_Text' }),
    'DevBanner_Title': () => msg('Click to view source', { id: 'DevBanner_Title' }),
    'Footer_MadeWith': () => msg('Made with an amalgamation of technologies that probably shouldn\'t work together, but somehow does:', { id: 'Footer_MadeWith' }),
    'Footer_Avalonia_Title': () => msg('Built with Avalonia UI Framework', { id: 'Footer_Avalonia_Title' }),
