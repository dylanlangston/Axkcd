...
interface DotnetHostBuilder {
  ...
  /**
   * Configures the Emscripten module with handlers for events like onAbort, onExit, onDownloadResourceProgress, etc.
   */
  withModuleConfig(config: DotnetModuleConfig): DotnetHostBuilder;
  /**
